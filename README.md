...
- Reads 8 analog potentiometers via two ADS1115 ADC modules (volume, eyes, spot, left arm, right arm, neck, jaw, + 1 unused channel)
...
Built-in ESP-IDF components used: `esp_now`, `WiFi`, `esp_adc_cal`
