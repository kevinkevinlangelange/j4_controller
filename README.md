...
- The TTGO's built-in button (GPIO 35) cycles the TFT through three screens: live data, WiFi MAC address, and a connection-status screen showing ESP-NOW LINK, j4_stepper, j4_talk, and j4_display as CONNECTED (green) / DISCONNECTED (red)
